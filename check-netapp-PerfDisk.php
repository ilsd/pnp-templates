...
# set initial values
	...
	# set graph labels
	$opt[$KEY]     = "-I --vertical-label $label -l 0 $upper --title \"Performance of harddisk '$ds_name[$KEY]'\" --watermark=http://netapp-monitoring.info";
	# Graph Definitions
	...
	if ($VAL['MAX'] != "") {
		...
		#$def[$KEY] .= rrd::hrule( $max[1], "#0459b3", "Size of Volume $max[0] \\n");
	}
